  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"Chaucha":{color:"#00FFC8", shape:"dot", alpha:1}, 
			 ...
			 /*Juego*/
			 Juego:{color:CLR.branch, shape:"dot", alpha:1},
			 /*Childs*/
				"Dice miner":{color:CLR.doc, alpha:0, link:'#dice-miner'},
				"Que chaucha":{color:CLR.doc, alpha:0, link:'#que-chaucha'},
				"Betgan":{color:CLR.doc, alpha:0, link:'#betgan'},
				"Chauchazo":{color:CLR.doc, alpha:0, link:'#chauchazo'},
        ...
        "Chile Crypto":{color:CLR.doc, alpha:0, link:'#chile-crypto'},
				"Chaucha Docs":{color:CLR.doc, alpha:0, link:'#chaucha-docs'},
				"Latamcoincap":{color:CLR.doc, alpha:0, link:'#latamcoincap'},
			 
			 /*Tienda*/
			 Tienda:{color:CLR.branch, shape:"dot", alpha:1},
				/*Childs*/
				"Tazones":{color:CLR.doc, alpha:0, link:'#tazones'},
				"WoodSkin":{color:CLR.doc, alpha:0, link:'#woodskin'},
			 
			 
			 /*Exchange*/
			 Exchange:{color:CLR.branch, shape:"dot", alpha:1},
				/*Childs*/
				"Excel exchange":{color:CLR.doc, alpha:0, link:'#excel-exchange'},
				"OrionX":{color:CLR.doc, alpha:0, link:'#orionx'},
				"SouthXchange":{color:CLR.doc, alpha:0, link:'#southXchange'},
			 ...
			 /*Software*/
			 Software:{color:CLR.demo, shape:"dot", alpha:1},			 
				 /*Apps*/
				 /*root*/
				 ...
				 "chaucha.cl":{'color':CLR.branch,'shape':'dot'},
					 ...
					 Quirquincho:{color:CLR.doc, alpha:0, link:'#quirquincho'},
					 Chungungo:{color:CLR.doc, alpha:0, link:'#chungungo'},
					 
				 /*WebPages Integraciones*/
				 /*root*/
	...
	var data = {
	   nodes:{
		 chaucha:{'color':'red','shape':'dot','label':'Chaucha'},
		 organizacion:{'color':'#998','shape':'dot','label':'Organizacion'},
		 exchange:{'color':'#998','shape':'dot','label':'Exchange'},
		 juego:{'color':'#998','shape':'dot','label':'Juego'},
		 plataforma:{'color':'#998','shape':'dot','label':'Plataforma'},
		 software:{'color':'#998','shape':'dot','label':'Software'},
		 tienda:{'color':'#998','shape':'dot','label':'Tienda'},
    ...
    /*setTimeout(function(){
					var postLoadData = {
					 ...
					 var postLoadData = {
						 nodes:{
							 app:{'color':'orange','shape':'dot','label':'joe'},
							 web:{'color':'orange','shape':'dot','label':'joe'},
							 otro:{'color':'orange','shape':'dot','label':'joe'},
							 },
						 edges:{
							 software:{ app:{}, web:{}, otro:{}}
							 }
						 };
